            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="p-3 bg-slate-950/40 border border-slate-850 rounded-lg">
                  <span className="block text-4xs text-slate-500 font-bold uppercase mb-1">Total Crimes</span>
                  <span className="text-lg font-bold text-white font-mono">{stats.total}</span>
                </div>
                <div className="p-3 bg-slate-950/40 border border-slate-850 rounded-lg">
                  <span className="block text-4xs text-slate-500 font-bold uppercase mb-1">Active Cases</span>
                  <span className="text-lg font-bold text-indigo-400 font-mono">{stats.active}</span>
                </div>
                <div className="p-3 bg-slate-950/40 border border-slate-850 rounded-lg">
                  <span className="block text-4xs text-slate-500 font-bold uppercase mb-1">High Severity</span>
                  <span className="text-lg font-bold text-rose-500 font-mono">{stats.highSeverity}</span>
                </div>
                <div className="p-3 bg-slate-950/40 border border-slate-850 rounded-lg">
                  <span className="block text-4xs text-slate-500 font-bold uppercase mb-1">Density Index</span>
                  <span className="text-lg font-bold text-amber-500 font-mono">{stats.densityScore} <span className="text-4xs text-slate-500">/10</span></span>
                </div>
              </div>
            </div>
