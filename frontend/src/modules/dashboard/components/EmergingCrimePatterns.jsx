    ...
    <div className="bg-white border border-[#E5E7EB] rounded-[24px] p-5 shadow-sm flex flex-col h-[400px] justify-between transition-all duration-200">
      ...
      <div className="flex items-start justify-between border-b border-[#E7EAF0] pb-3 mb-3 shrink-0">
        <div className="flex gap-3">
          ...
          <div className="flex flex-col justify-center">
            <h3 className="text-[15px] font-bold text-[#0F172A] tracking-tight leading-tight">Emerging Crime Patterns (AI)</h3>
            <p className="text-[11px] font-medium text-[#64748B] mt-0.5">AI-powered intelligence insights</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-1.5 bg-[#15803D]/10 px-2 py-0.5 rounded-full border border-[#15803D]/20 shrink-0 mt-1">
          ...
          <span className="text-[9px] font-bold text-[#15803D] uppercase tracking-wider">AI Analysis Running</span>
        </div>
      </div>
      ...
      <div className="shrink-0 mb-3">
        <div className="flex items-center justify-between mb-1.5">
          <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">AI Summary (Today)</span>
          <span className="text-[11px] font-extrabold text-[#0F172A]">12 Active Patterns</span>
        </div>
            ...
            <div key={i} className={`px-3 py-2 rounded-[14px] bg-white border border-[#E5E7EB] border-l-4 ${borderColor} hover:shadow-sm transition-shadow flex flex-col gap-1.5 group cursor-pointer shrink-0`}>
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-1.5 shrink-0">
                  <span className={`text-[9px] font-bold uppercase ${textColor}`}>{pat.confidence}</span>
      ...
      <div className="pt-2 border-t border-[#E7EAF0] flex justify-center shrink-0 mt-2">
        <button className="text-[11px] font-bold text-[#1E3A8A] hover:underline flex items-center gap-1">
