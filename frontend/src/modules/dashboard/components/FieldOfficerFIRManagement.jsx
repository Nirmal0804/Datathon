      ...
      <div className="bg-white border border-[#E7ECF3] rounded-[20px] sm:rounded-[24px] p-4 sm:p-6 shadow-sm flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 min-h-[80px] shrink-0">
        <div className="flex items-center gap-3.5 sm:gap-4">
          <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-[14px] sm:rounded-[16px] bg-[#0B1F4D] text-[#C79A2B] flex items-center justify-center shrink-0 shadow-xs">
            <FileText className="w-5 h-5 sm:w-6 sm:h-6 text-[#C79A2B]" />
          </div>
          <div>
            ...
            paginatedCases.map(c => {
              ...
              return (
                <div 
                  ...
                  className="bg-white rounded-[20px] sm:rounded-[24px] border border-[#E7ECF3] p-4 sm:p-6 shadow-xs hover:-translate-y-0.5 hover:shadow-md hover:border-l-4 hover:border-l-[#C79A2B] transition-all duration-250 cursor-pointer flex flex-col sm:flex-row sm:items-center justify-between gap-3.5 sm:gap-4 group"
                >
                  {/* Left: FIR Metadata */}
                  <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
                    <span className="font-mono font-extrabold text-[#0B1F4D] text-xs sm:text-sm tracking-tight bg-[#0B1F4D]/10 px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-[10px] sm:rounded-[12px] border border-[#0B1F4D]/20 shrink-0 w-fit">
                      {c.id}
                    </span>
                    <div>
            ...
            >
              ...
              <div className="p-6 space-y-6 overflow-y-auto flex-1 min-h-0">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="p-4 border border-[#E7ECF3] rounded-2xl flex items-center gap-3.5 bg-white shadow-xs">
                    <div className="p-2.5 bg-[#C79A2B]/15 text-[#C79A2B] rounded-xl">
