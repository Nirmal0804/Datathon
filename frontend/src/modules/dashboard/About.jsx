    ...
    <section id="about" className="py-20 sm:py-24 md:py-28 bg-white border-y border-[#E8EEF5] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          {/* LEFT SIDE: Image Placeholder Container */}
          <div className="lg:col-span-5 w-full">
            <div className="w-full aspect-[4/5] rounded-[24px] bg-[#F7F8FA] border-2 border-[#D49A00]/30 shadow-xs relative overflow-hidden flex items-center justify-center">
              {/* Dedicated space for actual project image to be added later */}
            </div>
          </div>
          ...
          <div className="lg:col-span-7 text-left">
            ...
            {/* Description */}
            <p className="text-[#142B45]/75 text-base sm:text-lg leading-relaxed mb-8 font-normal max-w-2xl">
            ...
            <div className="space-y-6 pt-2 border-t border-[#E8EEF5]">
              {/* BUILT BY */}
              <div>
