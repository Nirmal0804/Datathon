...
// TODO: Replace placeholder with real crime category breakdown data from API.
// Requires an endpoint that returns category-wise FIR distribution for the selected district.
