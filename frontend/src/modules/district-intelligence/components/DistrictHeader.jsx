        ...
        <div>
          <div className="flex items-center gap-3 mb-1">
            <h1 className="text-xl sm:text-2xl font-black text-[#0B1F4D] tracking-tight">
              {t('nav.districtIntelligence', 'District Intelligence')}
            </h1>
            <div className="px-3 py-1 rounded-full bg-[#F1F5F9] border border-[#E7ECF3] flex items-center gap-1.5">
              <span className="text-[11px] font-bold text-[#0B1F4D] uppercase tracking-widest whitespace-nowrap">
                {t('admin.active', 'AI Active')}
              </span>
            </div>
          </div>
          <p className="text-xs font-semibold text-[#64748B]">
            {t('district.subtitle', 'Command center for district-level crime intelligence.')}
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row items-center gap-3 w-full lg:w-auto">
        ...
        >
          ...
          <span className="text-[11px] font-bold text-emerald-700 uppercase tracking-widest">
            {t('reports.exportPDF', 'Export Report')}
          </span>
        </button>
      </div>
    </div>
